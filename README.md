FoodHub is a modern and responsive food ordering website built with React. This platform allows users to browse a variety of restaurants, explore menus, and place orders seamlessly.
